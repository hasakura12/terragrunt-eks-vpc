...
# pwd terragrunt-eks-vpc/ue1/dev/eks-control-plane-local-src-remote-deps/terragrunt.hcl
...
include "envcommon" {
  path = "${dirname(find_in_parent_folders())}/_envcommon/TEST/LOCAL_SRC_REMOTE_DEPS/eks-control-plane-local-src-remote-deps.hcl"
  ...
  # path           = "${get_parent_terragrunt_dir()}/_envcommon/TEST/LOCAL_SRC_REMOTE_DEPS/eks-control-plane-local-src-remote-deps.hcl"

  # TEST2
  # get_terragrunt_dir() returns LEAF of terragrunt.hcl folder: "/terraform/ue1/dev/eks"
  # path           = "${get_terragrunt_dir()}/_envcommon/TEST/LOCAL_SRC_REMOTE_DEPS/eks-control-plane-local-src-remote-deps.hcl"
