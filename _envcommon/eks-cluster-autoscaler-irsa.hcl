...
locals {
  ...
  base_source_url = "../../..//modules/eks-cluster-autoscaler-irsa" # relative path from execution dir
}
...
dependency "eks-irsa" {
  ...
  mock_outputs = {
    cluster_openid_connect_provider_arn = "dummy"
    cluster_openid_connect_provider_url = "dummy"
  }
...
# ---------------------------------------------------------------------------------------------------------------------
inputs = {
  cluster_openid_connect_provider_arn = dependency.eks-irsa.outputs.cluster_openid_connect_provider_arn
  cluster_openid_connect_provider_url = dependency.eks-irsa.outputs.cluster_openid_connect_provider_url
