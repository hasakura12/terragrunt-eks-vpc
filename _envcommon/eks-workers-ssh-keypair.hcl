...
locals {
  ...
  base_source_url = "../../..//modules/eks-workers-ssh-keypair" # relative path from execution dir
}
...
# ---------------------------------------------------------------------------------------------------------------------
inputs = {
  key_name = "eks-workers-keypair-${local.env}-${local.region_tag[local.region]}-${local.account_name}"
}