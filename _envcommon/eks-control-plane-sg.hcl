...
locals {
  ...
  base_source_url = "../../..//modules/eks-control-plane-sg" # relative path from execution dir
}
...
dependency "eks-workers" {
  config_path = "../eks-workers"

  # ref: https://terragrunt.gruntwork.io/docs/features/execute-terraform-commands-on-multiple-modules-at-once/#unapplied-dependency-and-mock-outputs
  mock_outputs = {
    node_security_group_id = "dummy"
  }
...
inputs = {
  ...
  # dependencies
  cluster_security_group_id = dependency.eks-control-plane.outputs.cluster_security_group_id
  node_security_group_id    = dependency.eks-workers.outputs.node_security_group_id
}